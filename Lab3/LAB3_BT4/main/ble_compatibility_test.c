...
#define SAMPLE_DEVICE_NAME "NHOM_1"
...
static void gap_event_handler(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_NC_REQ_EVT:
        ...
        ESP_LOGI(EXAMPLE_TAG, "ESP_GAP_BLE_NC_REQ_EVT, the passkey Notify number:%lu", param->ble_security.key_notif.passkey);
        break;
    ...
    case ESP_GAP_BLE_PASSKEY_NOTIF_EVT: /// the app will receive this evt when the IO has Output capability and the peer device IO has Input capability.
        ...
        ESP_LOGI(EXAMPLE_TAG, "The passkey notify number:%lu", param->ble_security.key_notif.passkey);
        break;
    ...
    case ESP_GATTS_WRITE_EVT:
        if (!param->write.is_prep)
        {
            ...
            for (int i = 0; i < param->write.len; i++)
            {
                ...
                sprintf(&datadone[i*2], "%02x", param->write.value[i]);
            }
